...
Cazador::Cazador(int posx, int posy, int colour, char element):Fantasma(posx, posy,colour, element), mt(1729), dist(0, 3)
{
}
...
void Cazador::generateRandomPos(int& x, int& y)
{
